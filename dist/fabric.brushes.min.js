...
b=new f.Image(b);this.canvas.add(b);b.set({left:c.x/a,top:c.y/a,scaleX:1/a,scaleY:1/a}).setCoords();this.canvas.clearContext(this.canvas.contextTop)};f.util.getRandom=function(a,b){b=b?b:0;return Math.random()*((a?a:1)-b)+b};f.util.clamp=function(a,b,c){"number"!==typeof c&&(c=0);return a>b?b:a<c?c:a};f.Stroke=f.util.createClass(f.Object,{color:null,inkAmount:null,lineWidth:null,_point:null,_lastPoint:null,_currentLineWidth:null,initialize:function(a,b,c,e,g,h){var l=f.util.getRandom(c),m=f.util.getRandom(2*
Math.PI),k=f.util.getRandom(2*Math.PI);c=l*Math.sin(k);l=l/2*Math.cos(k);k=Math.cos(m);m=Math.sin(m);this.ctx=a;this.color=e;this._point=new f.Point(b.x+c*k-l*m,b.y+c*m+l*k);this.lineWidth=g;this.inkAmount=h;this._currentLineWidth=g;a.lineCap="round"},update:function(a,b,c){this._lastPoint=f.util.object.clone(this._point);this._point=this._point.addEquals({x:b.x,y:b.y});a=this.inkAmount/(c+1);this._currentLineWidth=this.lineWidth*(.3<a?.2:0>a?0:a)},draw:function(){var a=this.ctx;a.save();this.line(a,
this._lastPoint,this._point,this.color,this._currentLineWidth);a.restore()},line:function(a,b,c,e,g){a.strokeStyle=e;a.lineWidth=g;a.beginPath();a.moveTo(b.x,b.y);a.lineTo(c.x,c.y);a.stroke()}});f.CrayonBrush=f.util.createClass(f.BaseBrush,{color:"#000",opacity:.6,width:30,_baseWidth:20,_inkAmount:10,_latestStrokeLength:0,_point:null,_sep:5,_size:0,_latest:null,_drawn:!1,initialize:function(a,b){b=b||{};this.canvas=a;this.width=b.width||a.freeDrawingBrush.width;this.color=b.color||a.freeDrawingBrush.color;
this.opacity=b.opacity||a.contextTop.globalAlpha;this._point=new f.Point(0,0)},onMouseDown:function(a){this.canvas.contextTop.globalAlpha=this.opacity;this._size=this.width/2+this._baseWidth;this._drawn=!1;this.set(a)},onMouseMove:function(a){this.update(a);this.draw(this.canvas.contextTop)},onMouseUp:function(){this._drawn&&this.convertToImg();this._latest=null;this._latestStrokeLength=0;this.canvas.contextTop.globalAlpha=1},set:function(a){this._latest?this._latest.setFromPoint(this._point):this._latest=
new f.Point(a.x,a.y);f.Point.prototype.setFromPoint.call(this._point,a)},update:function(a){this.set(a);this._latestStrokeLength=this._point.subtract(this._latest).distanceFrom({x:0,y:0})},draw:function(a){var b;var c=this._point.subtract(this._latest);var e=Math.ceil(this._size/2);var g=Math.floor(c.distanceFrom({x:0,y:0})/e)+1;c.normalize(e);var h=this._sep*f.util.clamp(this._inkAmount/this._latestStrokeLength*3,1,.5);var l=Math.ceil(this._size*this._sep);var m=this._size/2;a.save();a.fillStyle=
this.color;a.beginPath();for(e=0;e<l;e++)for(b=0;b<g;b++){var k=this._latest.add(c.multiply(b));var n=f.util.getRandom(m);var p=f.util.getRandom(2*Math.PI);var q=f.util.getRandom(h,h/2);var r=f.util.getRandom(h,h/2);var t=k.x+n*Math.sin(p)-q/2;k=k.y+n*Math.cos(p)-r/2;a.rect(t,k,q,r)}a.fill();a.restore();this._drawn=!0},_render:function(){}});f.FurBrush=f.util.createClass(f.BaseBrush,{color:"#000",opacity:1,width:1,_count:0,_points:[],initialize:function(a,b){b=b||{};this.canvas=a;this.width=b.width||
a.freeDrawingBrush.width;this.color=b.color||a.freeDrawingBrush.color;this.opacity=b.opacity||1},onMouseDown:function(a){this._points=[a];this._count=0;var b=this.canvas.contextTop,c=f.util.colorValues(this.color);b.strokeStyle="rgba("+c[0]+","+c[1]+","+c[2]+","+.1*this.opacity+")";b.lineWidth=this.width;this._points.push(a)},onMouseMove:function(a){this._points.push(a);var b=this.canvas.contextTop;var c=this._points;c=c[c.length-2];b.beginPath();b.moveTo(c.x,c.y);b.lineTo(a.x,a.y);b.stroke();for(c=
0;c<this._points.length;c++){var e=this._points[c].x-this._points[this._count].x;var g=this._points[c].y-this._points[this._count].y;var h=e*e+g*g;2E3>h&&Math.random()>h/2E3&&(b.beginPath(),b.moveTo(a.x+.5*e,a.y+.5*g),b.lineTo(a.x-.5*e,a.y-.5*g),b.stroke())}this._count++},onMouseUp:function(a){0<this._count&&this.convertToImg()},_render:function(){}});f.InkBrush=f.util.createClass(f.BaseBrush,{color:"#000",opacity:1,width:30,_baseWidth:20,_inkAmount:7,_lastPoint:null,_point:null,_range:10,_strokes:null,
