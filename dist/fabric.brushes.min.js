'use strict';(function(f){f.util.trimCanvas=function(a){for(var b=a.getContext("2d"),c=a.width,e=a.height,g=[],h=[],l=b.getImageData(0,0,c,e),m=function(p,q){return p-q},k=0;k<e;k++)for(var n=0;n<c;n++)0<l.data[4*(k*c+n)+3]&&(g.push(n),h.push(k));g.sort(m);h.sort(m);e=g.length-1;c=g[e]-g[0];e=h[e]-h[0];l=b.getImageData(g[0],h[0],c,e);a.width=c;a.height=e;b.putImageData(l,0,0);return{x:g[0],y:h[0]}};f.util.colorValues=function(a){if(a){if("transparent"===a.toLowerCase())return[0,0,0,0];if("#"===a[0])return 7>
