...
_baseWidth:10,_lastPoint:null,_lineWidth:3,_point:null,_size:0,initialize:function(a,b){b=b||{};this.canvas=a;this.width=b.width||a.freeDrawingBrush.width;this.color=b.color||a.freeDrawingBrush.color;this.opacity=b.opacity||a.contextTop.globalAlpha;this.canvas.contextTop.globalAlpha=this.opacity;this._point=new f.Point;this.canvas.contextTop.lineJoin="round";this.canvas.contextTop.lineCap="round"},_render:function(a){var b=this.canvas.contextTop;b.beginPath();var c=0;for(len=this._size/this._lineWidth/
2;c<len;c++){var e=(this._lineWidth-1)*c;b.globalAlpha=.8*this.opacity;b.moveTo(this._lastPoint.x+e,this._lastPoint.y+e);b.lineTo(a.x+e,a.y+e);b.stroke()}this._lastPoint=new f.Point(a.x,a.y)},onMouseDown:function(a){this._lastPoint=a;this.canvas.contextTop.strokeStyle=this.color;this.canvas.contextTop.lineWidth=this._lineWidth;this._size=this.width+this._baseWidth},onMouseMove:function(a){this.canvas._isCurrentlyDrawing&&this._render(a)},onMouseUp:function(){this.canvas.contextTop.globalAlpha=this.opacity;
